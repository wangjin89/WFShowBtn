...
-(UIImage *)starImage_Full{
    if(!_starImage_Full){
        _starImage_Full = [UIImage imageNamed:@"fullStars.png"];
    }
...
-(UIImage *)starImage_Empty{
    if(!_starImage_Empty){
        _starImage_Empty = [UIImage imageNamed:@"nofullStars.png"];
    }
